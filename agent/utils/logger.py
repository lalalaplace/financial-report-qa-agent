...
def build_agent_run_log(state: dict[str, Any]) -> dict[str, Any]:
    ...
    record: dict[str, Any] = {
        ...
        "clarification_decision": state.get("clarification_decision"),
        ...
        "final_answer_mode": state.get("final_answer_mode"),
        "answer_context_summary": state.get("answer_context_summary"),
        "llm_answer_raw_response": state.get("llm_answer_raw_response"),
        "answer_validation_passed": state.get("answer_validation_passed"),
        "answer_error_type": state.get("answer_error_type"),
        "stage_traces": state.get("stage_traces") or [],
